...
my $myPATH = "/home/mandeep/SCL/scl/skt_gen/noun";
    ...
    open(TMP1,">>/home/mandeep/SCL/tmp/SKT_TEMP/noun.log") || die "Can't open /home/mandeep/SCL/tmp/SKT_TEMP/noun.log for writing";
      if (param) {
        ...
        print "window.open('http://localhost/cgi-bin2/scl/SHMT/options1.cgi?word='+word+'','popUpWindow','height=500,width=400,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no, status=yes').focus();\n }\n </script>";

        print "</head>\n";

        print "<body onload=\"register_keys()\"> <script src=\"http://localhost/scl/SHMT/wz_tooltip.js\" type=\"text/javascript\"></script>\n";

        print `$myPATH/gen_noun.pl $rt $gen $encoding $level LOCAL`;
