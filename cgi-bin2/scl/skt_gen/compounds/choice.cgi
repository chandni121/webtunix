...
<h3><a href=\"http://localhost/scl/index.html\">Samsaadhanii</a></h3>
</center>
<br /> <br />";
...
if (param) {
  ...
  my $a = `echo "$avigraha" | /home/mandeep/SCL/scl/converters/wx2utf8.sh`;
  ...
  if (($rem_ques eq "") && ($user_choices ne "")) { # not 1st entry, no more questions
        &call_generator($avigraha,$ch0,$ch1,$ch2,$ch3,$ch4.$ch5,$ch6,$user_choices);
          ...
          if($ques_nos[0] eq "") { # 1st entry and no questions (eka+tA pari)
             ...
             my $prAwi1 = `echo "$prAwipaxikam1" | /home/mandeep/SCL/scl/converters/wx2utf8.sh`; chomp($prAwi1);
             my $prAwi2 = `echo "$prAwipaxikam2" | /home/mandeep/SCL/scl/converters/wx2utf8.sh`; chomp($prAwi2);
...
sub call_generator{
  my($avigraha,$ch0,$ch1,$ch2,$ch3,$ch4,$ch5,$ch6,$user_choices) = @_;
      ...
      print "<center><pre>\n";
      my $cmd = "echo '$user_choices' | /home/mandeep/SCL/scl/skt_gen/compounds/sanskrit_grammar.out \"$avigraha\" 1 | /home/mandeep/SCL/scl/converters/wx2utf8.sh";
      system($cmd);
      print "</pre></center>\n";
      #print "</div>";
}
...
sub call_choice{
  ...
  my($form);
          $form =  "<form name=\"f1\" method=\"get\" action=\"http://localhost/cgi-bin2/scl/skt_gen/compounds/choice.cgi\">\n";
