...
my $tmp_path="/home/mandeep/SCL/tmp/SKT_TEMP/NN/CG";
my $converters_path="/home/mandeep/SCL/scl/converters";
my $NNCG_path="/home/mandeep/SCL/scl/NN/CG";
my $CG_htdocspath="http://localhost/scl/NN/CG";
...
#        print "</center><br>";
	...
	open(TMP,">$tmp_path/tmp_in$pid/in.txt") || die "Can't open $tmp_path/tmp_in$pid/in.txt for writing";
        print TMP $nne,"\n";
        close(TMP);
        system("$converters_path/utf82wx.sh < $tmp_path/tmp_in$pid/in.txt | $NNCG_path/nne2diagram.out $type | $converters_path/wx2utf8.sh | /usr/bin/dot -Tjpg > $tmp_path/tmp_in$pid/a.jpg");
        $nne =~ s/</\&lt;/g;
        $nne =~ s/>/\&gt;/g;
        ...
        print "<br>";
   #     print "<a href=\"http://localhost/scl/NN/segmenter/index.html\"> Try Another<\/a>";
      }
